...
function initCursor() {
  ...
  document.addEventListener("mouseover", (e) => {
    const imgCard = (e.target as Element).closest(".project-card, .work-exp-card");
    isHoveringImage = !!imgCard;
    const interactive = (e.target as Element).closest(
      "a, button, .project-card, .work-exp-card, .category-header, .section-header, [onclick], .header-brand"
    );
